...
export const DOC_PAGES: DocPage[] = [
  ...
  },
  {
    ...
    "slug": "recurring-work",
    "description": "How recurring rules materialise work on a schedule, so routine jobs appear without anyone remembering them.",
    "blocks": [
      {
        "type": "h2",
        "text": "Work that repeats"
      },
      {
        "type": "p",
        "text": "Some work comes back on a rhythm: a weekly report, a monthly access review, a quarterly backup restore test. A **recurring rule** describes that work once and materialises a fresh task each time it is due, so the routine does not depend on anyone remembering it."
      },
      {
        "type": "p",
  ...
  },
  {
    ...
    "slug": "activity-inbox",
    "description": "The org-wide activity feed and your personal inbox: what changed, what needs you, and how notifications reach you.",
    "blocks": [
      {
        "type": "h2",
        "text": "Activity feed"
  ...
  },
  {
    "title": "Automations",
    "slug": "automations",
    "description": "Rules that act on work when it changes status — auto-label, assign, set priority, or route it — plus skills you can run on demand.",
    "blocks": [
      {
        "type": "h2",
        "text": "What this page covers"
