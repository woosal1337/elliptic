...
@mcp.tool
async def list_triage(org_id: str | None = None) -> dict[str, Any]:
...
@mcp.tool
async def accept_triage_task(task_id: str, org_id: str | None = None) -> dict[str, Any]:
...
async def decline_triage_task(
    task_id: str, reason: str | None = None, org_id: str | None = None
) -> dict[str, Any]:
